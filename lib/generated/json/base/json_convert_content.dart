...
import 'package:flutter_material/generated/json/global_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case HomeCoverImageEntity:
			...
			return homeCoverImageDataFromJson(data as HomeCoverImageData, json) as T;			case NoticeModelEntity:
			return noticeModelEntityFromJson(data as NoticeModelEntity, json) as T;			case NoticeModelEntityData:
			...
			return noticeModelEntityDataListFromJson(data as NoticeModelEntityDataList, json) as T;			case GlobalEntity:
			return globalEntityFromJson(data as GlobalEntity, json) as T;			case LoginModelEntity:
			...
			return loginModelDataAgentFromJson(data as LoginModelDataAgent, json) as T;			case HomeCommentModelEntity:
			return homeCommentModelEntityFromJson(data as HomeCommentModelEntity, json) as T;			case HomeCommentModelData:
			return homeCommentModelDataFromJson(data as HomeCommentModelData, json) as T;			case HomeCommentModelDataPage:
			return homeCommentModelDataPageFromJson(data as HomeCommentModelDataPage, json) as T;			case HomeCommantModelDataList:
			return homeCommantModelDataListFromJson(data as HomeCommantModelDataList, json) as T;			case HomeModelEntity:
			...
			return homeModelDataListCommantFromJson(data as HomeModelDataListCommant, json) as T;    }
    return data as T;
  }
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case HomeCoverImageEntity:
			...
			return homeCoverImageDataToJson(data as HomeCoverImageData);			case NoticeModelEntity:
			return noticeModelEntityToJson(data as NoticeModelEntity);			case NoticeModelEntityData:
			...
			return noticeModelEntityDataListToJson(data as NoticeModelEntityDataList);			case GlobalEntity:
			return globalEntityToJson(data as GlobalEntity);			case LoginModelEntity:
			...
			return loginModelDataAgentToJson(data as LoginModelDataAgent);			case HomeCommentModelEntity:
			return homeCommentModelEntityToJson(data as HomeCommentModelEntity);			case HomeCommentModelData:
			return homeCommentModelDataToJson(data as HomeCommentModelData);			case HomeCommentModelDataPage:
			return homeCommentModelDataPageToJson(data as HomeCommentModelDataPage);			case HomeCommantModelDataList:
			return homeCommantModelDataListToJson(data as HomeCommantModelDataList);			case HomeModelEntity:
			...
			return homeModelDataListCommantToJson(data as HomeModelDataListCommant);    }
    return data as T;
  }
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'HomeCoverImageEntity':
			...
			return HomeCoverImageData().fromJson(json);			case 'NoticeModelEntity':
			...
			return NoticeModelEntityDataList().fromJson(json);			case 'GlobalEntity':
			return GlobalEntity().fromJson(json);			case 'LoginModelEntity':
			return LoginModelEntity().fromJson(json);			case 'LoginModelData':
			return LoginModelData().fromJson(json);			case 'LoginModelDataAgent':
			return LoginModelDataAgent().fromJson(json);			case 'HomeCommentModelEntity':
			return HomeCommentModelEntity().fromJson(json);			case 'HomeCommentModelData':
			return HomeCommentModelData().fromJson(json);			case 'HomeCommentModelDataPage':
			return HomeCommentModelDataPage().fromJson(json);			case 'HomeCommantModelDataList':
			return HomeCommantModelDataList().fromJson(json);			case 'HomeModelEntity':
			...
			return HomeModelDataListCommant().fromJson(json);    }
    return null;
  }
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'HomeCoverImageEntity':
			...
			return List<HomeCoverImageData>();			case 'NoticeModelEntity':
			...
			return List<NoticeModelEntityDataList>();			case 'GlobalEntity':
			return List<GlobalEntity>();			case 'LoginModelEntity':
			return List<LoginModelEntity>();			case 'LoginModelData':
			return List<LoginModelData>();			case 'LoginModelDataAgent':
			return List<LoginModelDataAgent>();			case 'HomeCommentModelEntity':
			return List<HomeCommentModelEntity>();			case 'HomeCommentModelData':
			return List<HomeCommentModelData>();			case 'HomeCommentModelDataPage':
			return List<HomeCommentModelDataPage>();			case 'HomeCommantModelDataList':
			return List<HomeCommantModelDataList>();			case 'HomeModelEntity':
			...
			return List<HomeModelDataListCommant>();    }
    return null;
  }
